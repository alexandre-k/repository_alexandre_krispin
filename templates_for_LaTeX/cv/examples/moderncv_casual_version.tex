...
% \setmainfont{IPA P明朝} \usepackage{xcolor} character encoding
...
\homepage{http://niktarace.wordpress.com/} % optional, remove the line if not wanted
\extrainfo{\begin{center}
\scriptsize Dernière mise à jour : \today\ -- Écrit avec \fontspec{Times New
Roman}\XeTeX\end{center} }
...
\cvline{titre}{\emph{La notion de \emph{ren} %仁
...
\cvcomputer{Bureautique}{Microsoft Office, \LaTeX, \XeTeX, OpenOffice.org,
