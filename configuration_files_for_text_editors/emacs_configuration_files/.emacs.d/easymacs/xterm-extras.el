...
(defun xterm-extra-bind-keys ()
    ...
    (define-key function-key-map "\e[1;6P"  [S-C-f1])
    (define-key function-key-map "\eO6Q"    [S-C-f2])
    (define-key function-key-map "\e[1;6Q"  [S-C-f2])
    (define-key function-key-map "\eO6R"    [S-C-f3])
    (define-key function-key-map "\e[1;6R"  [S-C-f3])
    (define-key function-key-map "\eO6S"    [S-C-f4])
    (define-key function-key-map "\e[1;6S"  [S-C-f4])
    ...
    (define-key function-key-map "\e[1;4P"  [S-M-f1])
    (define-key function-key-map "\eO4Q"    [S-M-f2])
    (define-key function-key-map "\e[1;4Q"  [S-M-f2])
    (define-key function-key-map "\eO4R"    [S-M-f3])
    (define-key function-key-map "\e[1;4R"  [S-M-f3])
    (define-key function-key-map "\eO4S"    [S-M-f4])
    (define-key function-key-map "\e[1;4S"  [S-M-f4])
    ...
    (define-key function-key-map "\e[1;7P"  [M-C-f1])
    (define-key function-key-map "\eO7Q"    [M-C-f2])
    (define-key function-key-map "\e[1;7Q"  [M-C-f2])
    (define-key function-key-map "\eO7R"    [M-C-f3])
    (define-key function-key-map "\e[1;7R"  [M-C-f3])
    (define-key function-key-map "\eO7S"    [M-C-f4])
    (define-key function-key-map "\e[1;7S"  [M-C-f4])
    ...
    (define-key function-key-map "\e[1;8P"  [S-M-C-f1])
    (define-key function-key-map "\eO8Q"    [S-M-C-f2])
    (define-key function-key-map "\e[1;8Q"  [S-M-C-f2])
    (define-key function-key-map "\eO8R"    [S-M-C-f3])
    (define-key function-key-map "\e[1;8R"  [S-M-C-f3])
    (define-key function-key-map "\eO8S"    [S-M-C-f4])
    (define-key function-key-map "\e[1;8S"  [S-M-C-f4])
