...
set cpoptions-=c
" Avoid reinclusion
if exists("s:loaded_bracketing_base") && !exists('g:force_load_bracketing_base')
  finish 
endif
let s:loaded_bracketing_base = 1
...
vnoremap <silent> !mark! 
      \ :call InsertAroundVisual(Marker_Open(),Marker_Close(),0,0)<cr>
